...
async function migrateSalesCost() {
    console.log('=== STARTING EXPLICIT SALES DETAIL COST MIGRATION ===');
    ...
    try {
        ...
        for (const tenant of tenants) {
            ...
            try {
                ...
                console.log(`  - Running migration on 'detalle_ventas' for [${tenant.slug}]...`);
                await client.query(`
                    ALTER TABLE detalle_ventas 
                    ADD COLUMN IF NOT EXISTS costo_unitario_usd DECIMAL(12, 2) DEFAULT 0.00;
                `);
